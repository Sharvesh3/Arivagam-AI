      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 border-b border-gray-200 bg-white px-6 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center shadow-premium transition-premium hover:scale-105">
              <Sparkles className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-semibold text-gray-900">
                {currentConversationId ? 'Chat with Arivagam' : 'New Conversation'}
              </h1>
          ...
          <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
            {messages.length === 0 && (
              <div className="h-full flex items-center justify-center py-12">
                <div className="text-center max-w-2xl">
                  <div className="w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-premium transition-premium hover:scale-105">
                    <Sparkles className="w-10 h-10 text-primary-600" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-3">
                    Welcome to Arivagam AI
                  </h2>
            ...
            {loading && (
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center flex-shrink-0 shadow-premium">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-end gap-2">
              ...
              <button
                ...
                className="px-4 py-3 bg-gradient-to-r from-primary-600 to-primary-800 text-white rounded-xl hover:from-primary-700 hover:to-primary-900 disabled:opacity-50 disabled:cursor-not-allowed transition-premium shadow-premium hover:shadow-lg disabled:shadow-none"
              >
                {loading ? (
