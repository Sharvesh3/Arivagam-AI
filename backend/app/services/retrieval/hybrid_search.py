...
class HybridSearchService:
    ...
    async def search(
        ...
        logger.info(f"  Filters: doc_type={doc_type!r}, department={department!r}")
        logger.info(f"  Document filter: {document_filter!r}")
        logger.info(f"  Boost documents: {boost_documents!r}")
