...
class LLMService:
    ...
    def __init__(self):
        ...
        if settings.gemini_api_key:
            ...
            logger.warning("GEMINI_API_KEY is missing! Using application default credentials.")
        ...
        self.system_instruction = """You are Arivagam, a helpful AI assistant specializing in Finance and HRMS documentation.
...
- For greetings and general conversation, respond naturally without forcing document references"""
    ...
    @retry(
        ...
        wait=wait_exponential(multiplier=1, min=45, max=120)
    )
...
Please respond naturally and helpfully. You are Arivagam, an AI assistant that helps with Finance and HRMS documents. 
...
Use natural language, be warm and helpful."""
        ...
        messages.append({
            "role": "user",
            "parts": [{"text": "You are Arivagam, a friendly AI assistant. Respond naturally to user queries. Be helpful, conversational, and professional. Use markdown formatting (bullet points, bold, etc.) when appropriate."}]
        })
        messages.append({
            "role": "model",
            "parts": [{"text": "I understand. I'll be helpful, conversational, and use proper formatting."}]
        })
    ...
    async def generate_answer(
        ...
        messages.append({"role": "model", "parts": [{"text": "Understood. I'll provide accurate, context-aware responses with proper citations."}]})
    ...
    def _get_context_aware_system_instruction(
        ...
        """
        base_instruction = """You are Arivagam, a helpful AI assistant specializing in Finance and HRMS documentation.
